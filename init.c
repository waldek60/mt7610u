...
// }
// 
struct mt7610u_dev *mt7610u_alloc_device(struct device *pdev)
{
	struct ieee80211_hw *hw;
	struct mt7610u_dev *dev;

	hw = ieee80211_alloc_hw(sizeof(*dev), &mt7610u_ops);
	if (!hw)
		return NULL;
	...
	dev->stat_wq = alloc_workqueue("mt7610u", WQ_UNBOUND, 0);
	if (!dev->stat_wq) {
