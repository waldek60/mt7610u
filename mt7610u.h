...
struct mt7610u_mcu {
	...
	struct mt7610u_dma_buf resp;
	struct completion resp_cmpl;
};

struct mt7610u_freq_cal {
...
struct mt7610u_rx_queue {
	struct mt7601u_dev *dev;

	struct mt7610u_dma_buf_rx {
		struct urb *urb;
		struct page *p;
	} e[N_RX_ENTRIES];
...
struct mt7610u_tx_queue {
	struct mt7610u_dev *dev;

	struct mt7610u_dma_buf_tx {
		struct urb *urb;
		struct sk_buff *skb;
	} e[N_TX_ENTRIES];
...
enum {
	MT7610U_STATE_INITIALIZED,
	MT7610U_STATE_REMOVED,
	MT7610U_STATE_WLAN_RUNNING,
	MT7610U_STATE_MCU_RUNNING,
	MT7610U_STATE_SCANNING,
	MT7610U_STATE_READING_STATS,
	MT7610U_STATE_MORE_STATS,
};

/**
 * struct mt7610u_dev - adapter structure
